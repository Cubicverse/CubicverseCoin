...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/cubicversecoin-project/cubicversecoin>";
    const std::string URL_WEBSITE = "<https://cubicversecoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Cubicversecoin version %s\n", FormatFullVersion());
}
