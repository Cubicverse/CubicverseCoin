...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cubicversecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cubicversecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cubicversecoin transaction") + "\n" +
              "  cubicversecoin-tx [options] -create [commands]   " + _("Create hex-encoded cubicversecoin transaction") + "\n" +
              "\n";
